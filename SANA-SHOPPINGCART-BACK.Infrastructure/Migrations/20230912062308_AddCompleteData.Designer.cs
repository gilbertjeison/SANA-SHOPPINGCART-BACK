...
namespace SANA_SHOPPINGCART_BACK.Infrastructure.Migrations
{
    ...
    [Migration("20230912062308_AddCompleteData")]
            ...
            modelBuilder.Entity("SANA_SHOPPINGCART_BACK.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(5350));
                    ...
                    b.Property<DateTime>("UpdatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(5912));
            ...
            modelBuilder.Entity("SANA_SHOPPINGCART_BACK.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(6499));
                    ...
                    b.Property<DateTime>("UpdatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(7124));
            ...
            modelBuilder.Entity("SANA_SHOPPINGCART_BACK.Domain.Entities.OrderDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(7722));
                    ...
                    b.Property<DateTime>("UpdatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(8325));
            ...
            modelBuilder.Entity("SANA_SHOPPINGCART_BACK.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(8935));
                    ...
                    b.Property<DateTime>("UpdatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(9475));
            ...
            modelBuilder.Entity("SANA_SHOPPINGCART_BACK.Domain.Entities.ProductCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 155, DateTimeKind.Local).AddTicks(9968));

                    b.Property<DateTime>("UpdatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 12, 1, 23, 8, 156, DateTimeKind.Local).AddTicks(447));
